...
public class StructureUtility {
    ...
    public static <T> IStructureElementNoPlacement<T> ofTileAdder(ITileAdder<T> iTileAdder, Block hintBlock, int hintMeta) {
        ...
        return new IStructureElementNoPlacement<T>() {
            ...
            public boolean check(T t, World world, int x, int y, int z) {
                ...
                // This used to check if it's a tile. Since this is now an standalone mod we no longer do this
    ...
    // No more hatch adder. Implement it via tile adder. We could of course add a wrapper around it in mod, but not any more in this standalone mod.
     ...
     * <p>
     * NOTE: specific code got removed. TODO add a mean
     *
