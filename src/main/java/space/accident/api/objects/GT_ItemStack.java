...
public class GT_ItemStack {
	...
	public GT_ItemStack(ItemStack aStack, boolean wildcard) {
		this(aStack == null ? null : aStack.getItem(), aStack == null ? 0 : aStack.stackSize, aStack == null ? 0 : wildcard ? Values.W : Items.feather.getDamage(aStack));
	}
	...
	public final boolean isStackEqual(ItemStack aStack) {
		return Utility.areStacksEqual(toStack(), aStack);
	}
	
	public final boolean isStackEqual(GT_ItemStack aStack) {
		return Utility.areStacksEqual(toStack(), aStack.toStack());
	}
