 ...
 */
public interface IMachineProgress extends IWorldInteraction {
	/**
	 ...
	 */
	boolean increaseProgress(int progressInTicks);
	 ...
	 */
	default void setWorkDataValue(int value) {}
