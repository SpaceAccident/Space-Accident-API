...
import static space.accident.api.util.Utility.getTooltip;

public class GuiFakeItemButton implements IGuiScreen.IGuiElement {
	
	private GuiIcon bgIcon;
	private ItemStack item;
	private IGuiScreen gui;
	private int xPosition, yPosition;
	private List<String> itemTooltips;
	private final GuiTooltip tooltip = new GuiTooltip(null) {
		@Override
		...
		public Rectangle getBounds() {
			return GuiFakeItemButton.this.getBounds();
		}
	};
	private final Rectangle rectangle;
	private boolean mimicSlot;
	
	public GuiFakeItemButton(IGuiScreen gui, int x, int y, GuiIcon bgIcon) {
		this.gui = gui;
		this.bgIcon = bgIcon;
		item = null;
	...
	public GuiFakeItemButton setItem(ItemStack i) {
		item = i;
		if (getMimicSlot())
			updateTooltip();
		return this;
	...
	private void updateTooltip() {
		itemTooltips = (item == null) ? null : getTooltip(item, true);
	}
	...
	public GuiFakeItemButton setMimicSlot(boolean mimicSlot) {
	...
	public GuiIcon getBgIcon() {
		return bgIcon;
	}
	
	public GuiFakeItemButton setBgIcon(GuiIcon bgIcon) {
		this.bgIcon = bgIcon;
		return this;
	}
	...
	public void draw(int mouseX, int mouseY, float parTicks) {
		...
		if (bgIcon != null){
			GuiIcon.render(bgIcon, xPosition-1, yPosition-1, 18, 18,0,true);
		}
