...
public enum GuiIcon implements IGuiIcon {
	...
	private static ResourceLocation[] TEXTURES = {
			new ResourceLocation("textures/gui/GuiButtons.png"),
			new ResourceLocation("textures/gui/GuiCover.png"),
			new ResourceLocation("textures/gui/GuiTabs.png"),
	};
	...
	GuiIcon(int texID, int x, int y, int width, int height, IGuiIcon overlay) {
		this.x       = x;
		this.y       = y;
		this.width   = width;
		this.height  = height;
	...
	GuiIcon(int texID, int x, int y) {
		this(texID, x, y, 32, 32, null);
	}
	
	GuiIcon(int texID, int x, int y, int width, int height) {
