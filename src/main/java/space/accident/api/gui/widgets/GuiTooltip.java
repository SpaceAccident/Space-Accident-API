...
import static space.accident.api.util.TooltipDataCache.*;
...
public class GuiTooltip {
	 ...
	 * @param text
	 */
	public GuiTooltip(Rectangle bounds, String... text) {
		this.bounds = bounds;
		setToolTipText(text);
	}
	 ...
	 * @param data
	 */
	public GuiTooltip(Rectangle bounds, TooltipData data) {
		this.bounds = bounds;
