...
public class GuiIntegerTextBox extends GuiTextField implements IGuiScreen.IGuiElement {
	private final int x0, y0;
	private final IGuiScreen gui;
	public final int id;
	private boolean enabled;
	
	public GuiIntegerTextBox(IGuiScreen gui, int id, int x, int y, int width, int height) {
