...
public class TooltipDataCache {
	...
	private TooltipData getUncachedTooltipData(String key, Object... args) {
		...
		if (Math.max(Config.mTooltipVerbosity, Config.mTooltipShiftVerbosity) >= 3) {
		...
		return new TooltipData(
				lines.subList(0, getVerbosityIndex(Config.mTooltipVerbosity, normalLines, lines.size())),
				lines.subList(0, getVerbosityIndex(Config.mTooltipShiftVerbosity, normalLines, lines.size())));
	}
