...
public class DamageSources {
	...
	public static DamageSource getCombatDamage(String aType, EntityLivingBase player, IChatComponent aDeathMessage) {
		return new DamageSourceCombat(aType, player, aDeathMessage);
	}
	...
	private static class DamageSourceCombat extends EntityDamageSource {
		...
		public DamageSourceCombat(String aType, EntityLivingBase player, IChatComponent aDeathMessage) {
			super(aType, player);
