package space.accident.api.render;
...
import space.accident.main.render.TextureBuilder;
...
public final class TextureFactory {
	 ...
	 * @return The instance of an {@link ITexture} implementation
	 */
	public static ITexture of(final IIconContainer iconContainer, final int[] rgba, final boolean allowAlpha) {
		return builder().addIcon(iconContainer).setRGBA(rgba).setAllowAlpha(allowAlpha).build();
	}
	
	public static ITexture of(final IIconContainer iconContainer, final int[] rgba) {
	 ...
	 * @return The instance of an {@link ITexture} implementation
	 */
	public static ITexture of(final Block block, final int meta, final ForgeDirection side, final int[] rgba) {
